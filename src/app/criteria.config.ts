...
// Conversation-level criteria grouped by categories
export const conversationCriteriaCategories: CriteriaCategory[] = [
  {
    id: "safety_and_biasness",
    label: "SAFETY AND BIASNESS",
    criteria: [
      {
...
1 (Problematic): Fails to address major points or steps required for resolution. Critical omissions impede or prevent resolution.`,
      ...
      {
        id: "language_conciseness",
        label: "Language/Conciseness",
        description: `Evaluates the efficiency and precision of language use, assessing whether the response communicates effectively without unnecessary verbosity or redundancy.

3 (Excellent): Language is precise, concise, and efficient. Every word serves a purpose. No unnecessary repetition or verbose explanations. Communication is direct and to the point.

2 (Moderately Acceptable): Generally concise but may contain some redundant phrases or slightly verbose explanations. Minor opportunities for more efficient expression.

1 (Problematic): Language is unnecessarily verbose, repetitive, or inefficient. Contains redundant information or overly wordy explanations that obscure the main message.`,
        type: "rating",
        options: [1, 2, 3],
        ratingDescriptions: {
          "1": "Problematic:\nLanguage is unnecessarily verbose, repetitive, or inefficient.\nContains redundant information or overly wordy explanations.\nObscures the main message with unnecessary detail.",
          "2": "Moderately Acceptable:\nGenerally concise but may contain some redundant phrases.\nMinor opportunities for more efficient expression.\nSlightly verbose in some areas.",
          "3": "Excellent:\nLanguage is precise, concise, and efficient.\nEvery word serves a purpose.\nNo unnecessary repetition or verbose explanations.",
        } as RatingDescriptions,
      },
    ],
  },
...
export const conversationCriteria = conversationCriteriaCategories.flatMap(category => category.criteria);
